...
```sh
  cd my-folder
  https://github.com/kessie2862/Hello-Rails-React.git
```
<p align="right">(<a href="#readme-top">back to top</a>)</p>
...
## 🤝 Contributing <a name="contributing"></a>
  ...
  Feel free to check the [issues page](https://github.com/kessie2862/Hello-Rails-React/issues).
...
This project is [MIT](https://github.com/kessie2862/Hello-Rails-React/blob/feature/greeting/LICENSE) licensed.
